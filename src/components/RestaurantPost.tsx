...
const RestaurantPost = ({
    ...
    const link = `/restaurants/${slug}`;
    
    return (
        <article  className='p-[5px] md:p-2.5 xl:p-[14px] pb-5 hover:bg-white hover:rounded-md hover:shadow-md transition-all duration-300 max-h-fit'>
            ...
            <div className="card-content">
                ...
                <h2 className="text-base lg:text-lg font-bold text-tertiary mb-2.5 md:mb-5">
