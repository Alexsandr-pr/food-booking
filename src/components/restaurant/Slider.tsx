...
export default function Slider({ images }: { images: string[] }) {
    return (
        <div className="relative w-full">
            ...
            {/* Кнопка "Prev" */}
            <div className="prev-button absolute left-4 top-1/2 -translate-y-1/2 z-20 cursor-pointer">
            ...
            {/* Кнопка "Next" */}
            <div className="next-button absolute right-4 top-1/2 -translate-y-1/2 z-20 cursor-pointer" >
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
